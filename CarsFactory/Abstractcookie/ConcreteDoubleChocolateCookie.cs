...
{
    class ConcreteDoubleChocolateCookie: AbstractChocolateCookie
    {
        ...
        {
            Console.WriteLine("mix butter and sugar together in bowl, when fully and evenly mixed, pour in the flour and cocoa powder, then mix to a doughy elastic consistency");
        }
    }
}
